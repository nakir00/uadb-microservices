...
export default function FileUpload({maxSizeMB=5, maxFiles=6, onSubmit}:{maxFiles?: number, maxSizeMB?: number, onSubmit?: (files: Array<File | FileMetadata>) => void}) {
      ...
      >
        ...
        {files.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="mb-1.5 text-sm font-medium">Deposez vos fichiers ici</p>
            <p className="text-muted-foreground text-xs">
              maximum de {maxFiles} fichiers ∙ jusqu'a {maxSizeMB} MB
            </p>
