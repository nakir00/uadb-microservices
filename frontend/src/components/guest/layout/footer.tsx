...
const Footer = (props: Props) => {
  return (
    <footer className="w-full bg-black rounded-t-xl">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-8 py-10 xl:flex-row">
          ...
          <Link to='/' className={` flex  flex-row items-center gap-4 font-SheAlwaysWalksAlone text-primary`}>
            <Logo />
            <span className='text-lg font-[700] text-white font-palanquin'>Examen maodo</span>
          </Link>
          ...
          <div className="flex space-x-4 sm:justify-center ">
            <a
              href="#"
              className="flex items-center justify-center transition-all duration-500 border border-white rounded-full group w-9 h-9 "
            >
              <svg
                className="text-white transition-all duration-500 group-hover:text-orange"
            ...
            >
              <svg
                className="w-[1.25rem] h-[1.125rem] text-white transition-all duration-500  group-hover:text-orange"
                viewBox="0 0 15 15"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                className="w-[1rem] h-[1rem] text-white transition-all duration-500  group-hover:text-orange"
                viewBox="0 0 13 12"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            >
              <svg
                className="w-[1.25rem] h-[0.875rem] text-white transition-all duration-500  group-hover:text-orange"
                viewBox="0 0 16 12"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        <div className="border-t border-gray-200 py-7">
          <div className="flex items-center justify-center">
            <span className="text-gray-400 ">
              examen  © {DateTime.now().year}, tous droits reservés.
            </span>
          </div>
        </div>
      </div>
