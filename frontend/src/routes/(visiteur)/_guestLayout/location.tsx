...
export const Route = createFileRoute('/(visiteur)/_guestLayout/location')({
  component: RouteComponent,
})

function RouteComponent() {
  const { data: chambres, isLoading } = api.chambre.AsGuestGetAll({
    page: 0,
    size: 10,
  })

  if (!isLoading) {
    console.log('chambres', chambres.data.pages)
  }

  return (
    <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12 mt-28">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
          {isLoading ? (
            ...
            chambres.data.content.map((chambre: ChambreModel) => (
              <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div className="h-56 w-full">
                  <Link
                    to="/chambre/$chambreId"
                    params={{ chambreId: chambre.id?.toString() ||'0'  }}
                  >
                    {chambre.medias.length > 0 ? (
                      <img
                        className="mx-auto h-full w-full rounded-lg object-cover"
                        src={chambre.medias[0].url}
                        alt={chambre.medias[0].description || 'Chambre image'}
                      />
                    ) : (
                ...
                <div className="pt-6">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-4">
                    <p className="text-2xl font-extrabold leading-tight text-primary dark:text-white">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              >
                ...
                <span className="text-foreground">
                  {chambres.data.pageable.pageNumber + 1}
                </span>{' '}
                of{' '}
                <span className="text-foreground">
                  {chambres.data.totalPages}
                </span>
              </p>
