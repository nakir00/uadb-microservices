...
export const Route = createFileRoute('/locataire/_locataireLayout/rendez-vous/')({
...
function RouteComponent() {
  ...
  useEffect(() => {
    subscribe('refresh_locataire_rendez_vous_table', (e) => {
      refetch()
    })

    return () => {
      unsubscribe('refresh_locataire_rendez_vous_table', () => {})
    }
  }, [])
